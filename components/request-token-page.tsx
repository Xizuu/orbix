...
import {EyeIcon, EyeOffIcon, Rocket} from 'lucide-react'
                        ...
                        <Card className="w-[350px] bg-blue-900 border-blue-800">
                                    ...
                                    >
                                        {step === 1 ? (
                                            ...
                                            <form onSubmit={handleResetPassword}>
                                                <div className="space-y-4">
                                                    <div className="space-y-2">
                                                        <Label htmlFor="token" className="text-blue-200">Reset
                                                            Token</Label>
                                                        <motion.div whileFocus={inputVariants.focus}>
                                                            <Input
                                                                id="token"
                                                    ...
                                                    <div className="space-y-2">
                                                        <Label htmlFor="new-password" className="text-blue-200">New
                                                            Password</Label>
                            ...
                            <CardFooter>
                                <p className="text-sm text-blue-300">
                                    Remember your password? <Link href="/auth?tab=login"
                                                                  className="text-blue-400 hover:underline">Login</Link>
                                </p>
                            </CardFooter>
                        </Card>
                    </motion.div>
