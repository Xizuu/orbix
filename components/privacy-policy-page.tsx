    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-white overflow-hidden">
            ...
            <main className="flex-1 pt-14">
                <div
                    className="flex items-center justify-center min-h-screen bg-gradient-to-b from-black via-blue-900 to-black">
                    <motion.div
                    ...
                    >
                        ...
                        <p className="text-blue-200 mb-4">
                            Welcome to Orbix Hosting! Your privacy is important to us. This Privacy Policy explains how
                            we collect, use, and protect your personal information. By using our services, you agree to
                        ...
                        <ul className="list-disc pl-5 mb-4 text-blue-200">
                            <li><strong>Personal Data:</strong> While using our services, we may ask you to provide us
                                with certain personally identifiable information that can be used to contact or identify
                                you. This may include, but is not limited to, your email address, name, phone number,
                                and postal address.
                            </li>
                            <li><strong>Usage Data:</strong> We may also collect information on how the service is
                                accessed and used. This usage data may include information such as your computer's
                                Internet Protocol (IP) address, browser type, browser version, the pages of our service
                        ...
                        <p className="text-blue-200 mb-4">
                            ...
                            we transfer the data, including personal data, to India and process it there.
                        </p>
                        <p className="text-blue-200 mb-4">
                        ...
                        <p className="text-blue-200 mb-4">
                            Orbix Hosting may disclose your personal data in the good faith belief that such action is
                            necessary to:
                        </p>
                        <ul className="list-disc pl-5 mb-4 text-blue-200">
                        ...
                        <h2 className="text-2xl font-semibold text-blue-300 mb-2">10. Changes to This Privacy
                            Policy</h2>
                        <p className="text-blue-200 mb-4">
