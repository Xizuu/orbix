            ...
            <main className="flex-1 pt-14">
                <div
                    ...
                    >
                        ...
                        >
                            Welcome to Orbix Hosting! By using our services, you agree to the following terms and
                        ...
                        <motion.p
                            ...
                            className="text-blue-200 mb-4"
                        >
                            You agree to use our services in accordance with applicable laws and regulations. You are
                        ...
                        <motion.p
                            ...
                            className="text-blue-200 mb-4"
                        >
                            You are prohibited from using our services for unlawful purposes or in a way that could harm
                            the integrity or functionality of our services.
                        </motion.p>
                        <motion.h2
                            variants={fadeInVariants}
                            initial="initial"
                        ...
                        <motion.p
                            ...
                            className="text-blue-200 mb-4"
                        >
                            We reserve the right to terminate or suspend your account if you violate these Terms of
                        ...
                        <motion.p
                            ...
                            className="text-blue-200 mb-4"
                        >
                            Our liability is limited to the fullest extent permitted by law. We are not liable for any
