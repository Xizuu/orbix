              ...
              <CardContent>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                  <TabsList className="grid w-full grid-cols-2 bg-blue-800">
                    ...
                    <TabsTrigger value="signup" className="text-blue-200 data-[state=active]:bg-blue-700">
                      <motion.span whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                        Sign Up
                      </motion.span>
                    </TabsTrigger>
                        ...
                        <form onSubmit={handleLogin}>
                          <div className="space-y-4">
                            <div className="space-y-2">
                              ...
                              {loginEmailError && <p className="text-red-400 text-sm">{loginEmailError}</p>}
                            </div>
                            <div className="space-y-2">
                              ...
                              {loginPasswordError && <p className="text-red-400 text-sm">{loginPasswordError}</p>}
                            </div>
                          </div>
                          <motion.div
                        ...
                        <form onSubmit={handleSignup}>
                          <div className="space-y-4">
                            <div className="space-y-2">
                              ...
                              {signupNameError && <p className="text-red-400 text-sm">{signupNameError}</p>}
                            </div>
                            <div className="space-y-2">
                              ...
                              {signupEmailError && <p className="text-red-400 text-sm">{signupEmailError}</p>}
                            </div>
                            <div className="space-y-2">
                              ...
                              {signupPasswordError && <p className="text-red-400 text-sm">{signupPasswordError}</p>}
                            </div>
                            <div className="space-y-2">
                              ...
                              {signupConfirmPasswordError && <p className="text-red-400 text-sm">{signupConfirmPasswordError}</p>}
                            </div>
