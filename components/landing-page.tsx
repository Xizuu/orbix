...
import {Bot, Check, Clock, Globe, Mail, MessageCircle, Phone, Rocket, Server, Shield, Users, Zap} from "lucide-react"
    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-white">
            <header className="px-4 lg:px-6 h-14 flex items-center border-b border-blue-900 fixed w-full bg-black z-50">
                <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
                    ...
                    <nav className="flex gap-4 sm:gap-6">
                        <Link className="text-sm font-medium hover:text-blue-400 transition-colors duration-200"
                              href="#home">
                            Home
                        </Link>
                        <Link className="text-sm font-medium hover:text-blue-400 transition-colors duration-200"
            ...
            <main className="flex-1 pt-14">
                <section id="home"
                         className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-b from-black via-blue-900 to-black">
                        ...
                        <div className="flex flex-col items-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="mx-auto max-w-[700px] text-blue-200 md:text-xl lg:text-2xl">
                                    Unleash the full potential of your online presence with our cutting-edge hosting
                                    solutions.
                                </p>
                            </div>
                            <div className="space-x-4">
                                ...
                                <Button variant="outline"
                                        className="border-blue-600 text-blue-400 hover:bg-blue-900 transform hover:scale-105 transition-all duration-200"
                                        size="lg">
                ...
                <section id="services" className="w-full py-20 md:py-32 lg:py-40 bg-black">
                    <div className="container px-4 md:px-6 mx-auto">
                        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-12 text-blue-300">Our
                            Services</h2>
                        <Tabs defaultValue="all" className="w-full" onValueChange={setActiveTab}>
                            <TabsList className="flex flex-wrap justify-center mb-12 bg-transparent">
                                <TabsTrigger value="all"
                                             className="px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 data-[state=active]:bg-blue-600 data-[state=active]:text-white bg-opacity-20 hover:bg-opacity-30 bg-blue-800 mb-2 mx-1">All
                                    products</TabsTrigger>
                                <TabsTrigger value="web"
                                             className="px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 data-[state=active]:bg-blue-600 data-[state=active]:text-white bg-opacity-20 hover:bg-opacity-30 bg-blue-800 mb-2 mx-1">Web
                                    Hosting</TabsTrigger>
                                <TabsTrigger value="discord"
                                             className="px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 data-[state=active]:bg-blue-600 data-[state=active]:text-white bg-opacity-20 hover:bg-opacity-30 bg-blue-800 mb-2 mx-1">Discord
                                    Bot Hosting</TabsTrigger>
                                <TabsTrigger value="minecraft"
                                             className="px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 data-[state=active]:bg-blue-600 data-[state=active]:text-white bg-opacity-20 hover:bg-opacity-30 bg-blue-800 mb-2 mx-1">Minecraft
                                    Server Hosting</TabsTrigger>
                                <TabsTrigger value="rust"
                                             className="px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 data-[state=active]:bg-blue-600 data-[state=active]:text-white bg-opacity-20 hover:bg-opacity-30 bg-blue-800 mb-2 mx-1">Rust
                                    Server Hosting</TabsTrigger>
                                <TabsTrigger value="terraria"
                                             className="px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 data-[state=active]:bg-blue-600 data-[state=active]:text-white bg-opacity-20 hover:bg-opacity-30 bg-blue-800 mb-2 mx-1">Terraria
                                    Server Hosting</TabsTrigger>
                            </TabsList>
                            <div className="relative">
                                <TabsContent value="all"
                                             className={`grid gap-8 lg:grid-cols-3 transition-opacity duration-1000 ${activeTab === 'all' ? 'opacity-100' : 'opacity-0'}`}>
                                    <ProductCard
                                ...
                                <TabsContent value="web"
                                             className={`grid gap-8 lg:grid-cols-3 transition-opacity duration-1000 ${activeTab === 'web' ? 'opacity-100' : 'opacity-0'}`}>
                                    <PlanCard
                                        title="Basic"
                                        price="$5.99"
                                ...
                                <TabsContent value="discord"
                                             className={`grid gap-8 lg:grid-cols-3 transition-opacity duration-1000 ${activeTab === 'discord' ? 'opacity-100' : 'opacity-0'}`}>
                                    <PlanCard
                                        title="Starter"
                                        price="$4.99"
                                ...
                                <TabsContent value="minecraft"
                                             className={`grid gap-8 lg:grid-cols-3 transition-opacity duration-1000 ${activeTab === 'minecraft' ? 'opacity-100' : 'opacity-0'}`}>
                                    <PlanCard
                                        title="Basic"
                                        price="$9.99"
                                ...
                                <TabsContent value="rust"
                                             className={`grid gap-8 lg:grid-cols-3 transition-opacity duration-1000 ${activeTab === 'rust' ? 'opacity-100' : 'opacity-0'}`}>
                                    <PlanCard
                                        title="Starter"
                                        price="$14.99"
                                ...
                                <TabsContent value="terraria"
                                             className={`grid gap-8 lg:grid-cols-3 transition-opacity duration-1000 ${activeTab === 'terraria' ? 'opacity-100' : 'opacity-0'}`}>
                                    <PlanCard
                                        title="Basic"
                                        price="$7.99"
            ...
            <footer
                ...
                <div
                    className="flex flex-col items-center gap-2 sm:flex-row sm:justify-between w-full max-w-7xl mx-auto">
                    ...
                    <nav className="flex gap-4 sm:gap-6">
                        ...
                        <Link className="text-xs hover:underline underline-offset-4 text-blue-400"
                              href="/privacy-policy">
                            Privacy Policy
                        </Link>
...
function PlanCard({title, price, features}) {
    return (
        ...
        >
            <CardHeader>
                <CardTitle className="text-blue-300">{title}</CardTitle>
                <p className="text-2xl font-bold text-blue-400">{price}<span className="text-sm font-normal">/mo</span>
                </p>
            </CardHeader>
            <CardContent>
                ...
                <Button
                    className="w-full mt-4 bg-blue-600 hover:bg-blue-700 transform hover:scale-105 transition-all duration-200">
                    Choose Plan
                </Button>
            </CardContent>
        </Card>
